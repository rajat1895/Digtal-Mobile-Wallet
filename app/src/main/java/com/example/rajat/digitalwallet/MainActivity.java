...
public class MainActivity extends AppCompatActivity {
    ...
    private static Button bttn_chkbalance;
    private static Button bttn_recharge;
    private static Button bttn_sendmoney;
    private static Button bttn_offers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onClickButtonBalanceListner();
        onClickButtonRecharegListner();
        onClickButtonSendmoneyListner();
        onClickButtonOffersListner();
    ...
    public void onClickButtonBalanceListner(){
        bttn_chkbalance=(Button)findViewById(R.id.btn_1);
        bttn_chkbalance.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent("com.example.rajat.digitalwallet.ChkBalanceActivity");
                        startActivity(intent);
                    }
                }
        );
    }
    public void onClickButtonRecharegListner(){
        bttn_recharge=(Button)findViewById(R.id.btn_2);
        bttn_recharge.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent("com.example.rajat.digitalwallet.RechargeActivity");
                        startActivity(intent);
                    }
                }
        );
    }
    public void onClickButtonSendmoneyListner(){
        bttn_sendmoney=(Button)findViewById(R.id.btn_3);
        bttn_sendmoney.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent("com.example.rajat.digitalwallet.SendmoneyActivity");
                        startActivity(intent);
                    }
                }
        );
    }
    public void onClickButtonOffersListner(){
        bttn_offers=(Button)findViewById(R.id.btn_4);
        bttn_offers.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent("com.example.rajat.digitalwallet.OffersActivity");
                        startActivity(intent);
                    }
                }
        );
