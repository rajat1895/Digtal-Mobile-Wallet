...
public class ChkBalanceActivity extends AppCompatActivity {
    ...
    private static Button bttn_addmoney;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chk_balance);
        Payu.setInstance(this);
      // onClickButtonAddmoneyListner();
    }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ChkBalanceActivity.this);
    ...
    public void onClickButtonAddmoneyListner(){
        bttn_addmoney=(Button)findViewById(R.id.btn_add);
        bttn_addmoney.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent("com.example.rajat.digitalwallet.CheckoutActivity");
